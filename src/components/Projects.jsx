          ...
          {projects.map((project) => (
            ...
            >
              ...
              <img
                src={project.image}
                alt={project.title}
                className="rounded-lg mb-4 w-full h-40 object-cover shadow-2xl transition duration-500 group-hover:opacity-80"
                onError={(e) => { e.target.onerror = null; e.target.src = "https://placehold.co/600x400/1e293b/ffffff?text=Project+Image+Missing" }}
              />
        ...
        {selectedProject && (
          <div className="fixed inset-0 bg-black bg-opacity-80 flex items-center justify-center z-[100] p-4 transition-opacity duration-300" onClick={() => setSelectedProject(null)}>
            ...
            >
              ...
              {/* Close Button */}
              <button
                className="absolute top-3 right-3 bg-purple-600 hover:bg-purple-700 w-8 h-8 rounded-full flex items-center justify-center text-white text-lg transition duration-200 shadow-md"
              ...
              <img
                ...
                className="rounded-lg mb-6 w-full object-cover max-h-64 shadow-xl"
...
//     id: 1,
//     title: "OneCart E-Commerce Application",
//     description: `I’ve recently built OneCart, a complete MERN stack e-commerce application...`,
//     image: project1,
//     tech: ["MERN"],
//     liveLink: "https://new-one-cart-frontend.onrender.com/",
//     codeLink: "https://github.com/mohdbilal123456/New-One-Cart",
...
//     id: 2,
//     title: "Food Delivery Application",
//     description: "Frontend food ordering application simulating Zomato/Swiggy...",
//     image: project3,
//     tech: ["React JS", "Redux Toolkit", "Tailwind CSS"],
//     liveLink: "https://food-delivery-app-t7no.vercel.app/",
//     codeLink: "https://github.com/mohdbilal123456/Food-Delivery-App",
...
//     id: 3,
//     title: "AI Virtual Assistance",
//     description: `Voice-based AI virtual assistant built using React, Vanilla CSS, Gemini API...`,
//     image: project2,
//     tech: ["React JS","Vanilla CSS", "Gemini API"],
//     liveLink: "https://deluxe-macaron-3ecfda.netlify.app/",
//     codeLink: "https://github.com/mohdbilal123456/Virtual-Assistant",
//   },
// ];
